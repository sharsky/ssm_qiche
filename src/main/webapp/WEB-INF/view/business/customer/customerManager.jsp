    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="isexamine" value="1" title="审核通过">
                <input type="radio" name="isexamine" value="0" title="未审核">
                <input type="radio" name="isexamine" value="2" title="审核不通过">
            </div>
            <button type="button"
...
<div id="viewCarImageDiv" style="display: none;text-align: center">
    <img alt="驾驶证" width="700px" height="450px" id="view_carimg">
</div>
...
<div id="customerBar" style="display: none;">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs layui-btn-radius" lay-event="black">拉黑</a>
    <a class="layui-btn layui-btn-warm layui-btn-xs layui-btn-radius" lay-event="viewImage">查看驾照</a>
</div>
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item magb0">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">身份证号:</label>
                <div class="layui-input-block" style="padding: 5px">
                    <input type="text" name="identity" class="layui-input" lay-verify="required"
                           placeholder="请输入身份证号" style="height: 30px;border-radius: 10px">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item magb0">
            <%--<div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="vip" placeholder="请输入客户等级" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">失信次数:</label>
                <div class="layui-input-inline">
                    <input type="text" name="breakfaith" placeholder="请输入失信次数" autocomplete="off" class="layui-input">
                </div>
            </div>--%>
            <div class="layui-inline">
                <label class="layui-form-label">VIP等级:</label>
                <div class="layui-input-block" style="padding: 5px">
                    <input type="text" name="vip" lay-verify="number" class="layui-input"
                           placeholder="请输入客户等级" style="height: 30px;border-radius: 10px">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">失信次数:</label>
                <div class="layui-input-block" style="padding: 5px">
                    <input type="text" name="breakfaith" class="layui-input" lay-verify="number"
                           placeholder="请输入失信次数" style="height: 30px;border-radius: 10px">
                </div>
            </div>
        </div>
        <div class="layui-form-item magb0">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">客户电话:</label>
                <div class="layui-input-block" style="padding: 5px">
                    <input type="text" name="phone" lay-verify="number" class="layui-input"
                           placeholder="请输入客户电话" style="height: 30px;border-radius: 10px">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label" >审核状态:</label>
                <div class="layui-input-block" style="padding: 5px;top: -5px;">
                    <input type="radio" name="isexamine" value="1" title="审核通过">
                    <input type="radio" name="isexamine" value="2" title="审核不通过">
                    <input type="radio" name="isexamine" value="0" title="未审核">
                </div>
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'career', title: '租车类型', align: 'center', width: '150'}
                , {field: 'phone', title: '手机号码', align: 'center', width: '150'}
                , {field: 'vip', title: 'VIP等级', align: 'center', width: '150'}
                , {field: 'breakfaith', title: '失信次数', align: 'center', width: '150'}

                , {
                    field: 'isexamine', title: '审核状态', align: 'center', width: '120', templet: function (d) {
                        if (d.isexamine == 0){
                            return '<font color=blue>未审核</font>';
                        } else if (d.isexamine == 1){
                            return '<font color=blue>审核通过</font>';
                        }if (d.isexamine == 2){
                            return '<font color=blue>审核不通过</font>';
                        }
                ...
                , {field: 'createtime', title: '申请时间', align: 'center', width: '200'}
