...
<div style="display: none;padding: 20px" id="saveOrUpdateDiv">
    <form class="layui-form layui-row layui-col-space10" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-col-md12 layui-col-xs12">
            ...
            <div class="layui-form-item magb0">
                <div class="layui-inline">
                    <label class="layui-form-label">待出租数量:</label>
                    <div class="layui-input-block" style="padding: 5px">
                        <input type="text" name="notrentnum" class="layui-input" lay-verify="required|number"
                               placeholder="请输入车辆出租数量" style="height: 30px;border-radius: 10px">
                    </div>
                </div>
            </div>
            <div class="layui-form-item magb0">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'carnumber', title: '车牌号', align: 'center', width: '110',hide:'true'}
                ...
                , {field: 'notrentnum', title: '未出租数量', align: 'center', width: '110'}
                , {field: 'rentnum', title: '已出租数量', align: 'center', width: '110'}
                , {
